...
interface AlipayQRPaymentProps {
  amount: number;
  currency: string;
  orderNo: string;
  qrCode: string;
...
const AlipayQRPayment: React.FC<AlipayQRPaymentProps> = ({
  amount,
  currency,
  orderNo,
  qrCode,
      ...
      sx={{
        ...
        background: (theme) =>
          theme.palette.mode === 'dark'
            ? 'linear-gradient(135deg, rgba(0, 120, 215, 0.1) 0%, rgba(0, 120, 215, 0.05) 100%)'
            : 'linear-gradient(135deg, rgba(0, 120, 215, 0.05) 0%, rgba(0, 120, 215, 0.02) 100%)',
        borderRadius: 4,
        border: (theme) => `2px solid ${theme.palette.mode === 'dark' ? 'rgba(0, 120, 215, 0.3)' : 'rgba(0, 120, 215, 0.2)'}`,
      }}
    >
      {paymentStatus === 'paid' ? (
        <Box>
        ...
        <>
          ...
          >
            <QrCode2 sx={{ fontSize: 40, color: '#0078D7' }} />
          </Box>
...
export default AlipayQRPayment;
