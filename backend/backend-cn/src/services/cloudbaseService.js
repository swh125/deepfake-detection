...
const saveIPRecordCN = async (ipInfo) => {
  try {
    ...
    // Insert new record (does not include city, region_name, latitude, longitude fields)
    const ipRecord = {
    ...
    // Ensure these fields don't exist (even if they exist in collection structure, don't save them)
    delete ipRecord.city;
    delete ipRecord.region_name;
    delete ipRecord.latitude;
    delete ipRecord.longitude;
    ...
    return {
      ...
      ip: ipInfo.ip,
      country: ipInfo.country,
      // No longer return city, region, latitude, longitude fields
